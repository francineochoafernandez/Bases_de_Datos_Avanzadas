...
[<nombre_archivo_zip>]
empleando
Ruta y nombre donde se encuentra el archivo de texto que contiene un URL
por cada renglón de la imagen que será descargada de internet.
Total de imágenes a descargar, entre 1 y hasta 90 imágenes
Parámetro opcional que indica la ruta y nombre del archivo zip a generar.
...
absoluta y el nombre del archivo zip generado deberá ser exportado
